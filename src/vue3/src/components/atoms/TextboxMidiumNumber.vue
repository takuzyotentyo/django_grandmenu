<template>
    <input type="text" class="textbox--number_short"
        :value="modelValue" 
        @change="$emit('update:modelValue', halfSizeNumberFormat($event.target.value))"
        inputmode="numeric">
</template>
...
<style lang="scss" scoped>
    .textbox--number_short{
        @include selectbox($width: 82%);
        &[disabled]{
