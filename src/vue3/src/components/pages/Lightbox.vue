<template>
    <div>
        <UpFade>
            <div class="lightbox__spacer" v-show="lightBox !=''" @click="lightBoxShow('')"/>
        </UpFade>
        <UpFade>
            <div class="lightbox" :class="{ active: sideNav }" v-show="lightBox != ''">
                <keep-alive>
        ...
        <UpFade>
            <div class="lightbox__back icon--cancel" @click="lightBoxShow('')" v-show="lightBox != ''"></div>
        </UpFade>
    </div>
</template>
